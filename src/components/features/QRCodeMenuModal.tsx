      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] overflow-y-auto flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm bg-bg-card border border-gold/40 rounded-3xl p-6 sm:p-8 shadow-[0_10px_50px_rgba(0,0,0,0.8)] text-center space-y-6 text-txt-primary z-10 font-sans"
          >
            {/* Close Button */}
            <button
              onClick={() => setIsOpen(false)}
            ...
            <div className="space-y-2 pt-2">
              <div className="w-12 h-12 rounded-2xl bg-gold/15 text-gold border border-gold/40 flex items-center justify-center mx-auto shadow-[0_0_20px_rgba(197,155,39,0.25)]">
            ...
            <div className="relative p-5 rounded-2xl bg-white text-black max-w-[210px] mx-auto shadow-2xl border-2 border-gold/40 space-y-2">
              <svg
